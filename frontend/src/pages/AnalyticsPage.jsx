...
import { Users, Eye, MousePointerClick, TrendingUp, Globe, Clock, Loader2 } from 'lucide-react';
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-4 gap-6 mb-8">
               {[
                 { title: 'Total Visitors', value: kpis?.totalVisitors || '0', change: '+12.5%', icon: Users, color: 'text-blue-600', bg: 'bg-blue-50' },
                 { title: 'Page Views', value: kpis?.pageViews || '0', change: '+24.1%', icon: Eye, color: 'text-purple-600', bg: 'bg-purple-50' },
                 { title: 'Bounce Rate', value: kpis?.bounceRate || '0%', change: '-2.4%', icon: MousePointerClick, color: 'text-green-600', bg: 'bg-green-50' },
                 { title: 'Avg Session', value: kpis?.avgSession || '0s', change: '+1.2%', icon: Clock, color: 'text-orange-600', bg: 'bg-orange-50' },
               ].map(stat => (
